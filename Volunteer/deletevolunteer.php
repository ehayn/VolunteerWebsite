...
?>
	...
	<body><!-- begin body -->
		...
		if (isset($_POST['enter'])) //when the user clicks submit...  
			...
			if ($email == $email2)
			{	
				$sql = "DELETE FROM VOLUNTEER WHERE Email='".$email."'"; 						
        ...
        <div id ="info"><!--div for style reasons -->
			...
			<form action="deletevolunteer.php" method="post"> <!-- form info -->
			
            
            Please enter the email of the Volunteer you want to delete	
				<input class="form-control" type="email" maxlength = "50" value="<?php print $email; ?>" name="email" id="email"   /> <br />	
				
			Please reenter the email of the Volunteer you want to delete
