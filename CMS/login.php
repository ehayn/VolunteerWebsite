...
<body>
	...
	if(isset($_POST['enter']))
	{
		...
		{	$sql = "Call SP_FIND_USER_ID('".$un."', '".$ppa."',@uid)";
			...
			$userPermSite = $field->permsite;
				...
				if($userPermSite == 1 || $userPermSite == 0)
					Header ("Location:CMS.php") ;
				if($userPermSite == 2)
					Header ("Location:../Hope/volunteer.php") ;
		}
	...
	<div align = "center">
		<br><br><a href="http://hoperesourcectr.org/"><img src="images/hopelogo.jpg" width="105" height="99" alt=""></a></br>
